...
Pound signs alone do not count, for example: the string "#" would return an empty array. If a word is preceded by more than one hashtag, only the last hashtag counts (e.g. "##alot" would return ["alot"]) Hashtags cannot be within the middle of a word (e.g. "in#line hashtag" returns an empty array) Hashtags must precede alphabetical characters (e.g. "#120398" or "#?" are invalid) Input: String of words, where some words may contain a hashtag.
